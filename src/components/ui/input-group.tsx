...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: role="group" is intentional for input groups
    <div
      className={cn(
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/noStaticElementInteractions: mousedown handler focuses input, not interactive
    // biome-ignore lint/a11y/noNoninteractiveElementInteractions: mousedown handler focuses input, not interactive
    <div
